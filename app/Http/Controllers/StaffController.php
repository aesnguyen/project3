...
//lấy ra danh sách thông báo chờ
    ...
    public function getMedicalTestByAPi($id) {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_PORT => "8181",
            CURLOPT_URL => "https://192.168.0.110:8181/~/mn-cse/mn-name/PULSE?op=currentPulse",
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "origin: https://192.168.0.110:8181",
        ...
        return response()->json(array('FVC' => $FVC,'FEV1' => $FEV1,'PEF' => $PEF,'msg'=> $msg), 200);
    }
